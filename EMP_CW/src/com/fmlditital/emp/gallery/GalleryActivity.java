...
//		param.topMargin = 10;
		GridView adapterView1;
		adapterView1 = (GridView) ViewFactory
				.getAdapterView(this, AdapterSelect.gallerykey);
//		adapterView1.setLayoutParams(param);
		adapterView1.setAdapter(adapter);
		bodyLayout.addView(adapterView1,param);
		...
		Log.d("adapter ", "onCreate :::::::::: " +adapterView1);
		adapterView1.setOnItemClickListener(new OnItemClickListener() {
		...
		Log.d("GridView ", "adapterView   ::::::onCreate::::" +adapterView1);
//		if (adapterView1 instanceof GridView) {
...
//
//			adapterView1.setOnItemSelectedListener(new OnItemSelectedListener() {
//
