 ...
 *照片查看
 */
public class GalleryActivity extends AdapterViewActivity implements ImageLoadCallback{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		adapterView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Log.d("GalleryActivity>>>>>>>>>", "GalleryActivity click");
...
//			countView.setText("countView");
			...
			adapterView.setOnItemSelectedListener(new OnItemSelectedListener() {
				...
				public void onItemSelected (AdapterView<?> parent, View view, int position, long id) {
					...
					titleView.setText(((GalleryModel) data.get(position)).getgName()
			...
			try {
				...
				for (int i = 0; i < jsonArray.length(); i++) {
					...
					if (jsonObject2.getString("gstatus").equals("1")) {
						...
						Log.d("callJoinSuccess ","adapter.notifyDataSetChanged");
						Log.d("adapter ", ""+adapter.isEmpty());
					}
				}
