/* KindEditor 4.0.3 (2011-11-04), Copyright (C) kindsoft.net, Licence: http://www.kindsoft.net/license.php */
(function(B, l) {
	function ba(a) {
		if (!a) return ! 1;
	...
	if (!B.KindEditor) {
		...
		f.options = {
			...
			items: ["source", "|", "justifyleft", "justifycenter", "justifyright", "justifyfull", "insertorderedlist", "insertunorderedlist", "|", "fontname", "fontsize", "|", "forecolor", "hilitecolor", "bold", "italic", "removeformat", "|", "image", "link"],
			noDisableItems: ["source", "fullscreen"],
			colorTable: [["#E53333", "#E56600", "#FF9900", "#64451D", "#DFC5A4", "#FFE500"], ["#009900", "#006600", "#99BB00", "#B8D100", "#60D978", "#00D5FF"], ["#337FE5", "#003399", "#4C33E5", "#9933E5", "#CC33E5", "#EE33EE"], ["#FFFFFF", "#CCCCCC", "#999999", "#666666", "#333333", "#000000"],["#FFFFFF", "#FFFFFF", "#FFFFFF", "#FFFFFF", "#ffcf3c", "#fba549"]],
		...
		F(sa, {
			...
			insertimage: function(a, b, c, d, e, f) {
				...
				var temp = window.location.href.split("?")[0]+"uploads"+E(a).split("uploads")[1];
				a = '<img src="' + temp + '" data-ke-src="' + temp + '" ';
				c && (a += 'width="' + E(c) + '" ');
				d && (a += 'height="' + E(d) + '" ');
				b && (a += 'title="' + E(b) + '" ');
				f && (a += 'align="' + E(f) + '" ');
		...
		function(a) {
			...
			function() {
				b.createDialog({
					...
					width: 300,
					title: b.lang("about"),
					body: '<div style="margin:20px;"><div>KindEditor 4.0.3 (2011-11-04)</div><div>Copyright &copy; <a href="http://www.kindsoft.net/" target="_blank">kindsoft.net</a> All rights reserved.</div></div>'
				})
			});
