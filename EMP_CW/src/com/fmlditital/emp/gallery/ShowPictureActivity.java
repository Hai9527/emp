...
public class ShowPictureActivity extends DefaultActivity implements
	...
	public boolean onTouch(View v, MotionEvent event) {
		if (event.getAction() == MotionEvent.ACTION_DOWN) {
			...
			if (isvisible == true) {
				touchBarLayout.setVisibility(View.INVISIBLE);
				commentInteractLinearLayout.setVisibility(View.INVISIBLE);
				titleView.setVisibility(View.INVISIBLE);
				bottomBarLayout.setVisibility(View.INVISIBLE);
			}
			if (isvisible == false) {
				touchBarLayout.setVisibility(View.VISIBLE);
				commentInteractLinearLayout.setVisibility(View.VISIBLE);
	...
	protected void onStart() {
		super.onStart();
		showhandler.postDelayed(showrunnable, 5000);
	}
	...
	private Runnable showrunnable = new Runnable() {
		...
		public void run() {
			...
			bottomBarLayout.setVisibility(View.INVISIBLE);
			isvisible=false;
			showhandler.postDelayed(this, 5000);
		}
	};
}
