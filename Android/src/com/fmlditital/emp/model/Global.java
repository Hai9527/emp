...
import com.fmlditital.emp.video.VideoListActivity;
...
public class Global {
	...
	public static String[] functions = { PageFunction, "video", "music",
			"event", "gallery", "article", FormFunction, "mail", "cast",
			"notification" };

//	public static Class[] classes = { PageActivity.class,
//			VideoListActivity.class, MusicActivity.class, EventActivity.class,
//			GalleryActivity.class, ArticleActivity.class, FormActivity.class,
//			MailActivity.class, CastActivity.class, NotificationActicity.class };
