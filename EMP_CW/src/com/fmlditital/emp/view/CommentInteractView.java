...
public class CommentInteractView extends LinearLayout implements JsonInterface,
    ...
    public CommentInteractView(Context context,AttributeSet attrs){
    	super(context,attrs);
    	this.context=context;
    }
    public void init(String tid, String data_id,
...
//				LayoutParams.WRAP_CONTENT));
		...
		System.out.println("init--------2----------init");
		...
		System.out.println("init---------3---------init");
    }
