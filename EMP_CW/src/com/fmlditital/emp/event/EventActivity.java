...
//    private TextView attend,mightAttend;
	public void onCreate(Bundle savedInstanceState) {
		...
		topLinearLayout.setLayoutParams(new LayoutParams(LayoutParams.FILL_PARENT,Tools.dip2px(this, 35)));
		...
		LinearLayout.LayoutParams upParams=new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT,LayoutParams.FILL_PARENT);
		upParams.weight=1;
		upcomingButton.setLayoutParams(upParams);
		upcomingButton.setOnClickListener(new View.OnClickListener(){
			public void onClick(View v){
				showBody(upcoming);
				
			}});
		topLinearLayout.addView(upcomingButton);
		
		separator=new ImageView(this);
        separator.setBackgroundColor(Color.BLACK);
        separator.setBackgroundResource(R.drawable.widget_bar_cut_off);
        LinearLayout.LayoutParams sParams=new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT,LayoutParams.FILL_PARENT);
		separator.setLayoutParams(sParams);
		topLinearLayout.addView(separator);
        
		pastButton=new Button(this);
		pastButton.setBackgroundColor(Color.BLACK);
		...
		LinearLayout.LayoutParams pastParams=new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT,LayoutParams.FILL_PARENT);
		pastParams.weight=1;
		pastButton.setLayoutParams(pastParams);
		topLinearLayout.addView(pastButton);
...
//		bodyLayout.addView(touchView);//未发生事件和已发生事件的切换
		bodyLayout.addView(topLinearLayout);
