	<?php
	class Pages{
		function show_page($count,$page,$link,$offset)
		{
		   ...
		   if($page!=1){
				 $key.="<a href=\"".$link."&page=1\">First</a> ";        //First
				 $key.="<a href=\"".$link."&page=".($page-1)."\">Previous</a>"; //Previous
		   }
		   else
		   {
		   ...
		   for($i=$init;$i<=$max_p;$i++)
		   {
			   ...
			   else {$key.=" <a href=\"".$link."&page=".$i."\">".$i."</a>";}
		   }
		   if($page!=$pages)
		   {
			   $key.=" <a href=\"".$link."&page=".($page+1)."\">Next</a> ";//Next
			   $key.="<a href=\"".$link."&page=".$pages."\">Last</a>"; //Last
		   }
		   else
		   {
